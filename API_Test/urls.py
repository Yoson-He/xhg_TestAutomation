...
urlpatterns = [
    ...
    path('debug_form/', views_api.debug_form, name='debug_form'),
    path('api_debug/', views_api.api_debug, name='api_debug'),
    path('get_api/', views_api.get_api, name='get_api'),
    path('nodes/', views_api.get_nodes, name='nodes'),
    path('api_form/', views_api.api_form, name='api_form'),
    path('api_add/', views_api.api_request, name='api_request'),
    path('api_request/', views_api.api_add, name='api_add'),
